...
<!-- Add Document Modal -->
<form method="POST" action="{{ route('vendor.documentuploads')}}" enctype="multipart/form-data" >
    @csrf
    @method('PUT') 
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p id="form"><Small><small> <a href="{{ asset('storage/app/documents/') . '/' . $FDC}}" download> Download Form</a> </small></Small></p>  
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="text-info"> My Insurance, Financial and Safety Documents  </h4>   <br>                      
                    </div> 
