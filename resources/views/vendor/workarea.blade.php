                ...
                <div class="content table-responsive table-full-width"> <div class="card">   
                    <table class="table table-hover table-striped">    
                            <thead>  
                                ...
                                <th>Remote Rates</th>    <th>Remote Rates</th>                                                                            
...
@foreach ($ID as $IDs) 
 ...
 <input type="checkbox" id="1" name="Class[]" value="Metro" hidden>
                                                    <input type="text" name="FormID[]" value="{{$IDs->FormID}}" hidden> 
                                                   

                                                    <input type="checkbox" id="Metro" name="Type[]" value="Metro" class="@error('Type') is-invalid @enderror"  > 
                                                    ...
                                                    <div class="form-group-sm">
                                                      ...
                                                      <input type="number" class="form-control" name="Rate[]" placeholder="" maxlength="4"     oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >
                                                    ...
                                                    <div class="form-group-sm">
                                                      <div class="input-group">
                                                      <span class="input-group-addon">Rate </span>
                                                      <input type="number" class="form-control" name="Rate2[]" placeholder="Succeeding Hour" maxlength="4"     oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >
                                                    ...
                                                    <!---End Metro -->
                                                    <hr>   
 <input type="checkbox" id="2" name="Class[]" value="Regional" hidden>                                                    
                                                    
                                                    <input type="text" name="FormID[]" value="{{$IDs->FormID}}" hidden> 
                                                    <input type="checkbox" id="Regional" name="Type[]" value="Regional"> 
                                                    ...
                                                    <div class="form-group-sm col">
                                                      <div class="input-group">
                                                      <span class="input-group-addon">Rate</span>
                                                      <input type="number" class="form-control" name="Rate[]" placeholder="First Hour" maxlength="4"     oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" >
                                                    ...
                                                    <!---End Regional -->
                                                    <hr>   
 <input type="checkbox" id="3" name="Class[]" value="Remote" hidden>                                                      
                                                    <input type="text" name="FormID[]" value="{{$IDs->FormID}}" hidden> 
                                                                                                       
                                                    <input type="checkbox" id="Remote" name="Type[]" value="Remote"> 
                                                    <label for="Remote"> <p>Regional </p> </label>
