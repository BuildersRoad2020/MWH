            ...
            <div class="row">
                <div class="col-md-2 pull-right">
                    <select name="status" class="form-control @error('status') is-invalid @enderror col-md-6 offset-md-0" onchange="this.form.submit()">
                        ...
                        <option value="0" {{ '0' == old('status', $showdetailedcontractor->status) ? 'selected' : '' }}>
                            <font class="badge badge-warning" style="font-size:90%"> On Hold </font>
                        </option>
                        <option value="1" {{ '1' == old('status', $showdetailedcontractor->status) ? 'selected' : '' }}>
                            <font class="badge badge-success" style="font-size:90%"> Approved </font>
                        </option>
                    </select>
                </div>
            </div>
                        ...
                        <div class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>{{ __('City') }}</label>
                                        <input id="city" type="text" class="form-control" name="city" value="{{ old('city', $cityname  )}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input id="state" type="text" class="form-control" name="state" value="{{ old('state', $statename  )}}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input id="country" type="text" class="form-control" name="country" value="{{ old('country', $countryname  )}}" disabled>
                                    </div>
                                </div>
                                ...
                                <table class="table table table-hover table-striped">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="checkbox">
                                                    <input type="hidden" value="0" name="RDIS"> <input type="checkbox" id="RDIS" name="RDIS" value="1" {{ '1' ==old('RDIS', $showskillset->RDIS  ) ? 'checked' : ' ' }} disabled> <label for="RDIS"></label>
                                                </div>
                                            </td>
