...
class VendorController extends Controller
{
  ...
  {   //pag click sa update button(index page), populate na ang mga fields
  ...
  {     //function to update db record + with form validation
    ...
    Contractor::where(['user_id' => auth()->user()->id,])
      ->update([
        ...
        'abn' => $request['abn'],
        'Name_primarycontact' => ucwords($request['Name_primarycontact']),
        'countrycode' => $removedspacecountrycode,
        'phone_primary' => $intphone,
        'email_primary' => $passemailfromusers,
        'Name_secondarycontact' => ucwords($request['Name_secondarycontact']),
        ...
        'bsb' => strtoupper($request['bsb']),
        'accountnumber' => $request['accountnumber'],
        'accountname' => ucwords($request['accountname']),
  ...
  public function storetechnicians(Request $request)
  {    //create user and then create technician
